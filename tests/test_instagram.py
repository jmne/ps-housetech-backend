...
def test_instagram(client):
    ...
    5. Verify that each dictionary in latest_posts contains all the expected keys
    6. Check if the timestamp of returned posts is within the last 30 days
    """
    ...
    # Test get_latest_posts method with sample data
